...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AECollapsableTableView/AECollapsableTableView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AWSPushManager/AWSPushManager.framework"
